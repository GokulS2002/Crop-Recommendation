...
layout = [[sg.Text('                       CROP RECOMONDATION', font=("Stone", 30), text_color = 'Black',background_color='green')],                                                                                                      
         [sg.Text('Please enter the following details :-', font=("Stone", 20),background_color='green')],                                                                                         
         [sg.Text('Enter ratio of Nitrogen in the soil                                  :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone",20), size = (20,1) )],
         [sg.Text('Enter ratio of Phosphorous in the soil                           :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone", 20),size = (20,1))],
         [sg.Text('Enter ratio of Potassium in the soil                               :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone", 20),size = (20,1))],
         [sg.Text('Enter average Temperature value around the field        :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone", 20),size = (20,1)), sg.Text('*C', background_color='green',font=("Stone", 20))], 
         [sg.Text('Enter average percentage of Humidity around the field :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone", 20),size = (20,1)), sg.Text('%',background_color='green', font=("Stone", 20))], 
         [sg.Text('Enter PH value of the soil                                            :', font=("Stone", 20),background_color='green'), sg.Input(font=("Stone", 20),size = (20,1))], 
         [sg.Text('Enter average amount of Rainfall around the field        :', font=("Stone", 20),background_color='green' ), sg.Input(font=("Stone", 20),size = (20,1)),sg.Text('mm',background_color='green', font=("Stone", 20))],
         [sg.Text(size=(50,1),font=("Stone",20),background_color='green' , text_color = 'Black', key='-OUTPUT1-' )],
         [sg.Button('Submit', font=("Stone", 20)),sg.Button('Quit', font=("Stone", 20))] ]
window = sg.Window(' AI CROP RECOMONDATION', layout,background_color='green') 
